...
using HtmlTableHelper.Strategies.Injectors.Predefined;
...
namespace HtmlTableHelper.Logic
{
    ...
    public class HtmlTable<TRowModel>
    {
        ...
        /// <summary>
        /// Allows to add a custom filtering strategy on a column. Implement the <see cref="IColFilter"/> interface to pass a custom made filter to <paramref name="colFilter"/> or use the pre-defined filters located in <see cref="HtmlTableHelper.Strategies.Filters.Predefined"/> namespace
        /// </summary>
        /// <typeparam name="TCol"></typeparam>
        ...
        /// <summary>
        /// Alias for <see cref="AddColumn(string,HtmlTableHelper.Strategies.Injectors.IColDataInjector)"/> 
        /// </summary>
        /// <param name="colName"></param>
        /// <param name="injector">An implementation of <see cref="IColDataInjector"/>. Make your own or use the ones predefined in the <see cref="Strategies.Filters.Predefined"/> namespace</param>
        /// <returns>Returns the current <see cref="HtmlTable{TRowModel}"/> instance to allow method chaining</returns>
